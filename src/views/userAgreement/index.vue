<template>
	<div class="userAgreement">
		...
		<iframe src="https://www.chuyuol.com/agreement/user_agreement.html" frameborder="0" class="iframe_wrapper" ref="iframe"></iframe>
	</div>
</template>
