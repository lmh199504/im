<template>
	<div class="diamondCharge">
		<mt-header fixed title="钻石充值">
		...
		<div class="top">
			<div class="my_money">
				<div class="my_money_cl">钻石余额</div>
				<div class="my_money_cl">
					<span>{{ balance }}</span>
					<img src="http://icon.chuyuol.com/h5PayImages/baseImgs/diamond.png" alt="钻石" style="vertical-align: -1px;" />
				</div>
			</div>
		</div>

		<div class="content">
			<div class="choose_wrapper" style="margin-bottom: 0px;">
...
var diamondList = [
	{ product_id: 46, diamond: 1, money: '0.01', free: ['赠送1钻石', '赠送1聊币'] },
	{ product_id: 45, diamond: 1, money: '0.01', free: ['赠送1钻石', '赠送1聊币'] },
	{ product_id: 37, diamond: 290, money: '29.00', free: [] },
	{ product_id: 36, diamond: 190, money: '19.00', free: [] }
]
export default {
	data() {
		return {
...
<style>
.diamondCharge .mint-header-button.is-left,
.diamondCharge .mint-header-button.is-right {
	text-align: center !important;
}
.diamondCharge .mint-header-title {
	font-weight: bold;
}
.diamondCharge .mint-header.is-fixed {
	z-index: 10;
}
</style>