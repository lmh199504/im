  ...
  <div class="container">
    ...
    >
      <div class="chat-wrapper">
		...
		<div class="myrow">
			<div class="my-left" :class="{'hide':!showAll}">
				<side-bar />
			</div>
			<div class="my-right" :class="{'hide':!showAll}">
				<div class="my_icon" @click="showAll=!showAll">
					<i class="el-icon-arrow-left" :class="{'left':!showAll}"></i>
				</div>
				<current-conversation />
			</div>
		</div>
...
.my_icon .el-icon-arrow-right{
	transition all 0.4s ease
}
.my_icon .el-icon-arrow-left.left{
